...
def create_foc_esc_bom(subsystems: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    SUBSYSTEM_COMPONENTS = {
        ...
        "Gate Driver": [
            {"part_number": "UCC21520ADWRR", "category": "Gate_Driver", "manufacturer": "TI", "value": "4A/6A Dual Non-Isolated", "quantity": 3, "description": "Dual non-isolated half-bridge gate driver, VCC=5V"},
        ...
        "MCU Core": [
            ...
            {"part_number": "MCP1700T-3302E/TT", "category": "LDO_Regulator", "manufacturer": "Microchip", "value": "3.3V LDO 250mA", "description": "3.3V LDO: VIN connects to VCC (5V), VOUT connects to VCC_3V3 (3.3V)"},
            {"part_number": "ABM8-8.000MHZ", "category": "Crystal", "manufacturer": "Abracon", "value": "8MHz", "description": "HSE crystal"},
            {"part_number": "C2012X7R1E105K", "category": "Capacitor", "manufacturer": "TDK", "value": "1uF/25V", "quantity": 4, "description": "VDD bypass for STM32 (VCC_3V3)"},
            {"part_number": "C2012X7R1E104K", "category": "Capacitor", "manufacturer": "TDK", "value": "100nF/25V", "quantity": 8, "description": "MCU decoupling (VCC_3V3)"},
    ...
    if bom:
        bom.extend([
            {"part_number": "VCC", "category": "Power", "value": "VCC", "description": "5V power rail (main supply)"},
            {"part_number": "GND", "category": "Power", "value": "GND", "description": "Ground reference"},
            {"part_number": "VCC_3V3", "category": "Power", "value": "VCC_3V3", "description": "3.3V regulated rail for MCU (generated by MCP1700 LDO from VCC)"},
        ])
...
def create_design_intent(
    ...
    if ideation_artifacts:
        ...
        intent_parts.extend([
            ...
            "2. Gate Drivers: Non-isolated dual half-bridge drivers (UCC21520), VCC=5V supply",
            "3. Power Stage: SiC MOSFETs for high-efficiency switching",
            "4. MCU Core: STM32G4 microcontroller (3.3V), powered by MCP1700 LDO",
            ...
            "- VCC = 5V (main logic supply for gate drivers, CAN transceiver)",
            "- VCC_3V3 = 3.3V (regulated by MCP1700 LDO from VCC)",
            "  * MCP1700 LDO: pin VIN -> VCC (5V input), pin VOUT -> VCC_3V3 (3.3V output)",
            "  * STM32G431 VDD/VBAT/VDD_USB/VDDA pins -> VCC_3V3 (NOT VCC)",
            "  * STM32G431 CANNOT be connected to VCC (5V) - max VDD is 3.6V",
            ...
            "- Place MCP1700 LDO near MCU",
            "- Minimize current sense loop area",
            "- Proper decoupling for MCU on VCC_3V3 rail",
